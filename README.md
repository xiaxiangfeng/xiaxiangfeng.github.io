本人熟悉的前端框架有React和Vue，并在上个项目中使用了React全家桶；曾经开发过一个导航网站使用了Vue以及相关的开发套件。在学习和使用这两个框架时，做过一些比较，通过比较来进一步了解和学习这两个框架;比如Redux和Vuex,在使用异步Action时Vuex本身支持异步Action，React需要引入redux-thunk或者其他的库，Vuex对ES7的async、await也是支持的。
